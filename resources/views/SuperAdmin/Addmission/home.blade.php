...
@if ($data !=null)
  ...
  <div class="form-group">
    <label for="exampleInputEmail1">Basic Fee</label>
    <input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"  name="fee" placeholder="Enter fee" required>
...
@else
  ...
  <div class="form-group">
    <label for="exampleInputEmail1">Class</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"  name="class" placeholder="Enter Student name" required>
