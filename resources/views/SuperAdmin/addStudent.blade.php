        ...
        <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
            <div class="main-card mb-3 card">
                <div class="card-body"><h5 class="card-title">Add Student</h5>
                    <form class="" action="{{url('a/pAddStudent')}}">
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="position-relative form-group"><label for="name" class="">full name</label><input name="name" id="name" placeholder="enter your name" type="text" class="form-control"></div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="position-relative form-group"><label for="phone" class="">Roll no</label><input name="roll" id="phone" placeholder="enter your phone no" type="text"
                                                                                                                                         class="form-control"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="position-relative form-group"><label for="teacher" class="">Class Teachers</label><select name="class" id="">
