    ...
    <div class="tab-content">
        <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
            <div class="main-card mb-3 card">
                <div class="card-body"><h5 class="card-title">Add Staff</h5>
                    <form class="" action="{{url('AddStaff')}}">
                        <div class="form-row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="position-relative form-group"><label for="role" class="">School role</label><input name="role" id="role" placeholder="enter your role" type="text" class="form-control"></div>
                            </div>
                            <div class="col-md-6">
